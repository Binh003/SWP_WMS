...
<div class="subpage-container">
  ...
  <div class="profile-layout-grid">
    <div class="premium-card" style="padding: 40px 32px 32px 32px;">
      ...
      <form method="post" action="${pageContext.request.contextPath}/manage/suppliers" style="display: flex; flex-direction: column; gap: 20px;">
        ...
        <div style="margin-top: 12px; display: flex; gap: 12px; justify-content: flex-end;">
          <a href="${pageContext.request.contextPath}/manage/suppliers" class="premium-btn-outline" style="display: inline-flex; align-items: center; justify-content: center; text-decoration: none; height: 44px; line-height: 44px; box-sizing: border-box;">Hủy bỏ</a>
