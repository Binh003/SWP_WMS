...
<div class="subpage-container">
  ...
  <div class="premium-card" style="padding: 24px; margin-bottom: 24px;">
    <form action="${pageContext.request.contextPath}/manage/inventories" method="get" style="display: flex; gap: 16px; align-items: flex-end; flex-wrap: wrap;">
      ...
      <div style="display: flex; gap: 8px;">
        ...
        <c:if test="${not empty param.sku || not empty param.batchCode || not empty param.barcode || not empty param.brandId || not empty param.productLineId}">
          <a href="${pageContext.request.contextPath}/manage/inventories" class="premium-btn-outline" style="display: inline-flex; align-items: center; justify-content: center; height: 40px; padding: 0 20px; font-size: 14px; text-decoration: none; color: #ef4444; border-color: rgba(239, 68, 68, 0.3); border-radius: 8px; font-weight: 600; box-sizing: border-box; transition: all 0.2s;"
      ...
      <table class="premium-table">
        ...
        <tbody>
          <c:forEach var="i" items="${inventories}">
            <tr class="user-row">
              <td>
                <a href="${pageContext.request.contextPath}/manage/inventories?action=batchDetail&id=${i.id}" style="text-decoration: none;">
              ...
              <td style="text-align: center; vertical-align: middle;">
                <div class="action-dropdown-container" style="position: relative; display: inline-block; text-align: left;">
                  ...
                  <div class="action-dropdown-menu" style="display: none; position: absolute; right: 0; top: 40px; background: #ffffff; border: 1.5px solid var(--card-border); border-radius: 10px; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.08); z-index: 100; min-width: 180px; overflow: hidden; animation: slideDown 0.15s ease-out;">
                    <a href="${pageContext.request.contextPath}/manage/inventories?action=batchDetail&id=${i.id}" class="action-dropdown-item" style="display: flex; align-items: center; gap: 8px; padding: 12px 16px; font-size: 13px; font-weight: 600; color: var(--text-primary); text-decoration: none; transition: background 0.15s;">
                    ...
                    <c:if test="${currentUser.hasPermission('INVENTORY_WRITE')}">
                      <a href="${pageContext.request.contextPath}/manage/inventories?action=edit&id=${i.id}" class="action-dropdown-item" style="display: flex; align-items: center; gap: 8px; padding: 12px 16px; font-size: 13px; font-weight: 600; color: var(--text-primary); text-decoration: none; transition: background 0.15s;">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <c:if test="${currentUser.hasPermission('RECEIPT_WRITE') && i.quantityInStock <= i.minStockLevel}">
                      <a href="${pageContext.request.contextPath}/manage/receipts?action=create&productId=${i.productId}" class="action-dropdown-item" style="display: flex; align-items: center; gap: 8px; padding: 12px 16px; font-size: 13px; font-weight: 600; color: #d97706; text-decoration: none; transition: background 0.15s; background: #fffbeb;">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
