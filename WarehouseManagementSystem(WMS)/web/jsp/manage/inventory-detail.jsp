  ...
  <div class="subpage-header" style="margin-bottom: 24px; display: flex; justify-content: space-between; align-items: flex-end; flex-wrap: wrap; gap: 16px;">
    ...
    <div style="display: flex; gap: 12px;">
      <c:if test="${currentUser.hasPermission('RECEIPT_WRITE')}">
        <a href="${pageContext.request.contextPath}/manage/receipts?action=create&productId=${inventory.productId}" class="premium-btn-primary" style="display: inline-flex; align-items: center; justify-content: center; gap: 8px; text-decoration: none; height: 40px; padding: 0 16px; background-color: #10b981; border-color: #10b981;">
      ...
      <c:if test="${currentUser.hasPermission('INVENTORY_WRITE')}">
        <a href="${pageContext.request.contextPath}/manage/inventories?action=edit&id=${inventory.id}" class="premium-btn-outline" style="display: inline-flex; align-items: center; justify-content: center; gap: 8px; text-decoration: none; height: 40px; padding: 0 16px;">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <tr class="history-row" style="border-bottom: 1px solid var(--card-border);">
              ...
              <td style="padding: 14px 16px; vertical-align: middle;">
                <div style="display: flex; flex-direction: column; gap: 4px; align-items: flex-start;">
                  <img src="${pageContext.request.contextPath}/manage/barcode?code=${item.barcode}" alt="Barcode" style="height: 32px; max-width: 180px; object-fit: contain; background: #ffffff; border: 1px solid var(--card-border); padding: 2px; border-radius: 4px;" />
              ...
              <td style="padding: 14px 16px; text-align: center;">
                <div class="action-dropdown-container" style="position: relative; display: inline-block; text-align: left;">
                  ...
                  <div class="action-dropdown-menu" style="display: none; position: absolute; right: 0; top: 40px; background: #ffffff; border: 1.5px solid var(--card-border); border-radius: 10px; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.08); z-index: 100; min-width: 150px; overflow: hidden; animation: slideDown 0.15s ease-out;">
                    <a href="${pageContext.request.contextPath}/manage/inventories?action=detail&id=${item.id}" class="action-dropdown-item" style="display: flex; align-items: center; gap: 8px; padding: 12px 16px; font-size: 13px; font-weight: 600; text-decoration: none; transition: background 0.15s;">
