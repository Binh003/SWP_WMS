...
<div class="subpage-container">
  <div style="margin-bottom: 16px;">
    <a href="${pageContext.request.contextPath}/manage/products" class="back-link" style="display: inline-flex; align-items: center; gap: 8px; text-decoration: none; color: var(--text-secondary); font-weight: 600; font-size: 14px; transition: color 0.2s;" onmouseover="this.style.color='var(--primary-color)'" onmouseout="this.style.color='var(--text-secondary)'">
  ...
  <div class="subpage-header" style="margin-bottom: 24px; display: flex; justify-content: space-between; align-items: flex-end;">
    ...
    <c:if test="${currentUser.hasPermission('PRODUCT_WRITE')}">
      <div>
        <a href="${pageContext.request.contextPath}/manage/products?action=edit&id=${product.id}" class="premium-btn-primary" style="display: inline-flex; align-items: center; justify-content: center; gap: 8px; text-decoration: none; height: 40px; padding: 0 16px;">
      ...
      <div style="display: flex; flex-direction: column; gap: 16px;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
          <div>
            ...
            <div>
              <a href="${pageContext.request.contextPath}/manage/product-lines?action=view&id=${product.productLine.id}" class="premium-tag premium-tag--manager" style="font-size: 12px; text-decoration: none; display: inline-block;">
          ...
          <div>
            ...
            <div>
              <a href="${pageContext.request.contextPath}/manage/brands?action=view&id=${product.productLine.brand.id}" class="premium-tag premium-tag--admin" style="font-size: 12px; text-decoration: none; display: inline-block;">
          ...
          <div style="display: flex; flex-direction: column; gap: 20px;">
            ...
            <c:if test="${currentUser.hasPermission('INVENTORY_WRITE')}">
              <div style="margin-top: 12px;">
                <a href="${pageContext.request.contextPath}/manage/inventories?action=edit&productId=${product.id}" class="premium-btn-outline" style="display: flex; align-items: center; justify-content: center; gap: 8px; text-decoration: none; width: 100%; box-sizing: border-box; height: 40px;">
