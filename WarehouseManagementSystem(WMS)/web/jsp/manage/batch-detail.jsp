          ...
          <c:forEach var="i" items="${batchInventories}">
            <tr class="user-row">
              ...
              <td style="text-align: center;">
                <a href="${pageContext.request.contextPath}/manage/inventories?action=detail&id=${i.id}" class="premium-btn-outline" style="padding: 6px 12px; font-size: 12px; text-decoration: none; display: inline-flex; align-items: center; justify-content: center; height: auto;">
                  Xem chi tiết
                </a>
              </td>
            </tr>
