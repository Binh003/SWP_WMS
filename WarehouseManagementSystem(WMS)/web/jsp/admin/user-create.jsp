    ...
    <div class="profile-btn-stack">
      <div class="premium-card" style="padding: 24px;">
        ...
        <ul style="margin: 0; padding-left: 20px; font-size: 13px; color: var(--text-secondary); line-height: 1.8;">
          ...
          <li><strong>MANAGER:</strong> Quản lý kho, điều hành các hoạt động nhập tồn và kiểm kho.</li>
          <li><strong>STAFF:</strong> Nhân viên kho, thực hiện các thao tác nhập kho, cập nhật dữ liệu.</li>
